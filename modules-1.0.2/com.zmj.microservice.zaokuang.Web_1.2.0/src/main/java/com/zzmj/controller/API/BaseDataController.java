...
import com.zmj.web.microservice.zaokuangContract.API.BaseDataContract;
...
@RestController
public class BaseDataController implements BaseDataContract {
	...
	@Override
	public SysResult setConfig(@RequestParam(name = "Workface_Id", required = false) String workfaceId,
