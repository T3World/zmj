...
public interface ZZUserMapper {
	 ...
	 * @return
	 */
	List<ZZUserEntity> getlikeKeyWord(@Param("keyWord") String keyWord, @Param("pageNo") Integer pageNo,
	 ...
	 * @return: List<ZZUserEntity>
	 */
	List<ZZUserEntity> listUserByOrgId(@Param("orgId") String orgId, @Param("rowNo") int rowNo,
