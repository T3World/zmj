...
import com.zmj.microservice.filterstation.FilterStationApplication;
...
@SpringBootTest(classes = FilterStationApplication.class)
@WebAppConfiguration
public class T1 {
    @Autowired
    ...
    public void getHello() throws  Exception{
         ...
         */
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.post("/FilterStation/getInOutPressureData")
                .content("{\"dataSourceName\":\"zaokuang/qiwu/217\"," +
                        "\"startTime\":\"1556928000000\"," +
                        "\"pressureType\":\"all\"," +
                        "\"endTime\":\"1556928000000\"}")
